...
use crate::regs::PPB_BASE;
pub const VTOR: u32 = 0xed08;
// pub fn get_vtable() -> u32 {
//     let vtor: *const u32 = (PPB_BASE + VTOR) as *const u32;
//     unsafe {
//         let v_table: *mut u32 = core::ptr::read_volatile(vtor) as *mut u32;
//     }
// }
#[derive(Clone, Copy)]
union Vector {
...
impl VectorTable {
    ...
    pub fn init(&mut self, ppb: &mut rp2040_hal::pac::PPB) {
        let vector_table = ppb.vtor().read().bits();
        unsafe {
            rp2040_hal::rom_data::memcpy44(
    ...
    #[allow(unknown_lints)]
    #[allow(clippy::needless_pass_by_ref_mut)]
    pub unsafe fn activate(&mut self, ppb: &mut rp2040_hal::pac::PPB) {
        ppb.vtor()
